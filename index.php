...
<body id="home">
	...
	<div class="welcome wrap-width">
		...
		<div class="welcome-text">
			<p id="text-heading">vedavyasa.org</p><br>
			<p id="text-context">vedavyasa institute of technology is a platform where companies can find the internees,<br>employees, workers for them. It provides the educational documents,<br> certificates, curriculum vitae (CV) of the users. </p>
	...
	<div class="link-container clearfix">
		<div class="wrap-width">
			...
			<p id="join">Join the vedavyasa institute of technology - Be a part of the growing community.</p>
		</div> 
	</div>	 <!-- link-container -->
	...
	<div class="about-container clearfix wrap-width" id="about">
		...
		<p>vedavyasa institute of technology is a platform where students can get their documents verified and attested digitally. Companies can view their docs and offer them internships and jobs.</p>
	...
	<footer>
		...
		<div id="copyrights">
				<span class="siteName">vedavyas.org ©  2020. All rights reserved.</span>
            </div><!--copyrights-->
	</footer>
